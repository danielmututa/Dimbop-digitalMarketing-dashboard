...
//     console.log(`Making request to: /api/products/${productId}/reviews`)
...
// // Update a review (if needed later)
...
// ): Promise<Review> => {
//   try {
//     const response = await apiClient.put(`/api/products/${productId}/reviews/${reviewId}`, data)
//     return response.data
//   } catch (error) {
...
//     throw new Error('An unexpected error occurred while updating the review')
//   }
// }

// // Delete a review (if needed later)
...
//   try {
//     const response = await apiClient.post(`/api/products/reviews/${reviewId}/comments`, data);
//     return response.data;
//   } catch (error) {
//     if (axios.isAxiosError(error)) {
//       const backendError = error.response?.data;
...
// export const AddReview = async (
//   productId: string | number,
//   data: { user_id: number; rating: number; comment: string; user_name?: string }
// ): Promise<Review> => {
//   try {
//     if (!data.user_id) {
//       throw new Error('User ID is required');
...
//       rating: data.rating,
//       comment: data.comment.trim(),
//       user_name: data.user_name // ✅ Include user_name
//     });
