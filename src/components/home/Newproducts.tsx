...
//           return (
//             <divllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll
//               key={product.id}
//               className="mb-[20px] w-full sm:w-[48%] lg:w-[30%] xl:w-[23%] relative h-[400px] group"
//             >
//               <div className="relative w-full h-[300px] overflow-hidden rounded-lg">
...
//   // Dialog states for the second design
//   const [isDialogOpen, setIsDialogOpen] = useState<boolean>(false);
//   const [selectedProduct, setSelectedProduct] = useState<Product | null>(null);
//   const [quantity, setQuantity] = useState<number>(1);
