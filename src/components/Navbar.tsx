...
//         <NavLink 
//           to="/home" 
//           className="text-white font-montserrat hover:font-montserratBold"
//         >
//           Home
//         </NavLink>
...
//             <ChevronDown 
//               size={14} 
//               className={`text-white transition-transform duration-300 ${openMenu === 'pages' ? 'rotate-180' : ''}`} 
//             />
//           </button>
//           <div 
//             className={`absolute left-0 mt-[18px] flex-col w-48 bg-white border rounded shadow-lg z-10 transition-all duration-300 origin-top ${
...
//             <ChevronDown 
//               size={14} 
//               className={`text-white transition-transform duration-300 ${openMenu === 'shop' ? 'rotate-180' : ''}`} 
//             />
//           </button>
//           <div 
//             className={`absolute left-0 mt-[18px] w-48 bg-white border rounded shadow-lg z-10 transition-all duration-300 origin-top ${
...
//             <ChevronDown 
//               size={14} 
//               className={`text-white transition-transform duration-300 ${openMenu === 'blogs' ? 'rotate-180' : ''}`} 
//             />
//           </button>
//           <div 
//             className={`absolute left-0 mt-[18px] w-48 bg-white border rounded shadow-lg z-10 transition-all duration-300 origin-top ${
